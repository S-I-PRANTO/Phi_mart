...
SECRET_KEY = 'django-insecure-6g+(6qlb6ge%2h2)s79c5-@)^aiwk6g1h23#ykb28_9t(j^&n+'
...
cloudinary.config( 
    cloud_name = config('cloudnari_name'), 
    api_key = config('cloudnari_API_key'), 
    api_secret = config('cloudnari_API_secret'),
    secure=True
)
